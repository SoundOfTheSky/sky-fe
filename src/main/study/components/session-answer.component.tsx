  ...
  return (
    <div class={`card ${s.answer}`}>
      ...
      <div class={s.buttons}>
        <Tooltip
          content={
            t('STUDY.SESSION.SHUFFLED_SUBJECTS') +
            ': ' +
            t(shuffleSubjects() ? 'COMMON.ENABLED' : 'COMMON.DISABLED')
          }
        >
          <button
            onClick={() => {
        ...
        <Tooltip
          content={
            t('STUDY.SESSION.CONSISTENT_QUESTIONS') +
            ': ' +
            t(shuffleSubjects() ? 'COMMON.ENABLED' : 'COMMON.DISABLED')
          }
        >
        ...
        <Tooltip
          content={t(
            questionAnswered()
              ? 'STUDY.SESSION.NEXT_QUESTION'
              : 'STUDY.SESSION.TO_ANSWER',
          )}
        >
          <button
            onClick={submit}
        ...
        <Tooltip content={t('STUDY.SESSION.AUTO_AUDIO')![autoplayAudio()]}>
